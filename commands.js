const commands = [
    ...
    options: [
      {
        type: 6,
        name: "user",
        description: "เลือกผู้ใช้ที่ต้องการเพิ่มเข้าแบล็คลิสต์นะคะ",
        required: true
      }
    ]
  },
  {
    name: "whitelist",
    description: "นำผู้ใช้ออกจากแบล็คลิสต์ค่ะ",
    options: [
      {
        type: 6,
        name: "user",
        description: "เลือกผู้ใช้ที่ต้องการนำออกจากแบล็คลิสต์นะคะ",
        required: true
      }
    ]
  },
